...
This program was built for and tested on Linux systems.
...
This program can be built from the makefile in the source directory. If boost is not installed in the preferred directory, you may change the path to the library and/or include folders in the makefile by editing the path(s) after "lib =" and/or "include =". LD_LIBRARY_PATH must be set to the path of the compiled boost libraries or you will get a dynamic linking error.
